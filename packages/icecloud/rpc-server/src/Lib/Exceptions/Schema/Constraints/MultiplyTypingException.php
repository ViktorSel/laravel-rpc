...
class MultiplyTypingException extends SchemaException
{
    public function __construct(Constraint $constraint)
    {
        parent::__construct("Ограничение '{$constraint->key()}' не может быть применено. Обнаружено множественное определение типов");
    }
}
